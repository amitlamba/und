...
interface SegmentUserServiceClient {
    ...
    fun users(@PathVariable("segmentId") segmentId: Long, @PathVariable("clientId") clientId: Long,  @RequestHeader("Authorization") token: String,@RequestParam("include")includeUsers:IncludeUsers): List<EventUser>
