export class AppSettings {
  ...
  public static API_ENDPOINT_CLIENT_CLIENT_GET_SMS_TEMPLATE_BY_ID = AppSettings.API_ENDPOINT_CLIENT_CLIENT_SMS + "/template";
  ...
  public static API_ENDPOINT_CLIENT_GET_WEBPUSH_TEMPLATE_BY_ID = AppSettings.API_ENDPOINT_CLIENT_WEBPUSH + "/template";
  ...
  public static API_ENDPOINT_CLIENT_GET_ANDROID_TEMPLATE_BY_ID = AppSettings.API_ENDPOINT_CLIENT_ANDROID + "/template";
