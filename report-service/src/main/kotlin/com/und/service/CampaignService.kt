...
//                            java.time.LocalDateTime.now().plusMinutes(1L)
//                        } else {
...
//                ?: if (testWebCampaign.findByType == null || testWebCampaign.toAddresses == null) throw CustomException("Either findByType or address is missing.")
...
//            this.clientID = AuthenticationUtils.clientID ?: throw org.springframework.security.access.AccessDeniedException("Access Denied.")
...
//                        Now.Now -> java.time.LocalDateTime.now()
...
//                    }
//                    if (endTime == null) endTime = java.time.LocalDateTime.now().plusYears(10)
