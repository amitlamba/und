...
class FunnelReportServiceImplTest {
    ...
    fun testWithoutSplit(){
        ...
        val funnelFilter = FunnelReport.FunnelReportFilter(segmentid = 1, conversionTime = 10, days = 10,
                funnelOrder = FunnelReport.FunnelOrder.default, splitProprty = null, splitProprtyType = GlobalFilterType.Technographics,
    ...
    fun testWithSplit(){
        ...
        val funnelFilter = FunnelReport.FunnelReportFilter(segmentid = 1, conversionTime = 10, days = 10,
                funnelOrder = FunnelReport.FunnelOrder.default, splitProprty = "os", splitProprtyType = GlobalFilterType.Technographics,
                steps = listOf("Search", "View").map { it -> FunnelReport.Step(eventName = it, order = 1) })
