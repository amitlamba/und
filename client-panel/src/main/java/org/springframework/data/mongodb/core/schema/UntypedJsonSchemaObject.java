...
public class UntypedJsonSchemaObject implements JsonSchemaObject {
    ...
    static class Restrictions {
        ...
        public Restrictions(Collection<? extends Object> possibleValues, Collection<JsonSchemaObject> allOf, Collection<JsonSchemaObject> anyOf, Collection<JsonSchemaObject> oneOf, JsonSchemaObject notMatch) {
